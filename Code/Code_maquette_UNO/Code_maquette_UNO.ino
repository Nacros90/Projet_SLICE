...
const int MICROSTEPPING = 8; // Pas de jumpers = 1
...
const float VITESSE_TANGENTIELLE_CIBLE = 7.5; // Vitesse de ton train en cm/s
...
const long SEUIL_PAS_Y = 16;             // Seuil plus bas en Full Step
const float VITESSE_X_MIN = 10.0;      
const float VITESSE_X_MAX = 4000.0;     // Plafond de sécurité adapté au Full Step
